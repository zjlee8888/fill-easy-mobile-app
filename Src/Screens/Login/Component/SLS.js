        ...
        <View style={styles.container}>
            ...
            <View style={{ ...styles.textinput, justifyContent: "center", flexDirection: "row",}}>
                <TextInput placeholder="Password"
                    ...
                    style={{ width: "85%",letterSpacing:1, textAlign: "center", paddingLeft: "5%", fontSize: 16, }}
                />
...
const styles = StyleSheet.create({
    container: { width: "100%", alignItems: "center", justifyContent: "space-around" , flex:1},
    heading: {
        fontSize: 32,
        color: "#000000",
        width: "100%",
    ...
    signininput: { width: "90%", borderBottomWidth: 1, padding: 5, paddingVertical: 10, borderBottomColor: "rgba(177 , 179 , 183 , 0.8)", marginTop: 8 }
