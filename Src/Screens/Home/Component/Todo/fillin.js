...
{/* 
                        ...
                        <View style={{
                            ...
                            <TEXT title='The following fields are all mandatory fields to fill in your form.
                                    ...
                                    <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                        <TouchableOpacity style={{
                                            ...
                                            <View style={{
                                                width: 14,
                                                height: 14,
                                                backgroundColor: item.type == idtype ? '#2B299E' : '#ffffff',
                                                borderRadius: 14 / 2
                                            }}></View>
                                        </TouchableOpacity>
                        ...
                        <View style={{
                            ...
                            <TextInput placeholder="Y123456(1)"
                                placeholderTextColor="rgba(164, 164, 164, 1)"
                                value={iddocument}
